    ...
    <div className="relative">
      ...
      <div className="fixed z-10 bottom-0 left-0 pl-10 hidden md:block">
        <div className="flex flex-col items-center space-y-6">
          <Github className="hover:text-[#e9c46a] text-gray-300 hover:transform hover:translate-x-0.5 duration-500 cursor-pointer" />
          <Instagram className="hover:text-[#e9c46a] text-gray-300 hover:transform hover:translate-x-0.5 duration-500 cursor-pointer" />
          <Twitter className="hover:text-[#e9c46a] text-gray-300 hover:transform hover:translate-x-0.5 duration-500 cursor-pointer" />
          <Linkedin className="hover:text-[#e9c46a] text-gray-300 hover:transform hover:translate-x-0.5 duration-500 cursor-pointer" />
          <Facebook className="hover:text-[#e9c46a] text-gray-300 hover:transform hover:translate-x-0.5 duration-500 cursor-pointer" />
          {/* Vertical Line */}
      ...
      <div className="fixed z-10 bottom-0 right-0 pr-10 hidden md:block ">
        <div className="flex flex-col items-center justify-center gap-y-2">
          <div className="relative w-max group mx-auto mt-12">
            <p
              className="cursor-pointer text-gray-400 hover:text-[#e9c46a] tracking-wider font-sans transition-transform transform hover:-translate-y-1 duration-500"
