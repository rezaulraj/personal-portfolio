    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center justify-center md:items-start">
      ...
      <div>
        ...
        <li className="text-gray-300 text-justify pb-2 tracking-wide">
          ...
          <span className="text-[#e9c46a]"> Next.js</span> for gobal state
          management
          <span className="text-[#e9c46a]"> Redux</span>,
          <span className="text-[#e9c46a]"> Zustand</span> and styling with
          <span className="text-[#e9c46a]"> Tailwind CSS </span>
        ...
        <li className="text-gray-300 text-justify pb-2 tracking-wide">
          ...
          <span className="text-[#e9c46a]">MySQL</span>,{" "}
          <span className="text-[#e9c46a]">Postgresql</span>. I ensure seamless
          data management, API integrations, and server-side logic that powers
          modern applications.
        </li>
        <li className="text-gray-300 text-justify pb-2 tracking-wide">
